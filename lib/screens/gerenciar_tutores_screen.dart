...
class _GerenciarTutoresScreenState extends State<GerenciarTutoresScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Gerenciar Tutores', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                const Icon(Icons.people_outline, size: 60, color: Colors.white70),
                const SizedBox(height: 20),
                const Text('Nenhum Tutor Cadastrado', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                const SizedBox(height: 8),
                Text('Os tutores pendentes e aprovados aparecerão aqui.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white.withOpacity(0.7))),
              ],
            ),
          ),
        ),
              ...
              Row(
                children: [
                  ...
                  Chip(
                    ...
                    backgroundColor: isPendente ? Colors.orange.withOpacity(0.8) : Colors.green.withOpacity(0.8),
                  ),
                ],
              ),
              const SizedBox(height: 4),
              Text(tutor.email, style: TextStyle(color: Colors.white.withOpacity(0.8))),
                ...
                children: [
                  if (isPendente)
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(backgroundColor: Colors.green.withOpacity(0.8), padding: const EdgeInsets.symmetric(vertical: 12)),
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(backgroundColor: Colors.red.withOpacity(0.8), padding: const EdgeInsets.symmetric(vertical: 12)),
