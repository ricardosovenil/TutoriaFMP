...
class FmpApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/',
      // A propriedade 'routes' foi substituída pela 'onGenerateRoute' para maior flexibilidade
      onGenerateRoute: (settings) {
        ...
        // Se a rota não for encontrada ou os argumentos forem nulos, volta para a tela inicial.
        return MaterialPageRoute(builder: (_) => const TelaEscolhaUsuario());
      },
    );
  }
...
// O restante do arquivo (TelaEscolhaUsuario) permanece o mesmo, então foi omitido para brevidade.
